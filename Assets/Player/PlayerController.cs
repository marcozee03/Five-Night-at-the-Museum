...
public class PlayerController : MonoBehaviour
{
    ...
    private void HoverInteractableObject()
    {
        ...
        {
            StatTracker.hud.SetHoverText(interactionOverride.HoverText());
        }
    }
    public InteractableObject interactionOverride;
